...
function test_scripts(){
    ...
    wp_enqueue_script('test-popper','//cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.6/umd/popper.min.js',array('jquery'),false,true);
...
/*
 * Подключение миниатюр в админку и регистрация своих размеров картинок
 */
